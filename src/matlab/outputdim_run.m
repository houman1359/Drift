...
plot_root = fullfile('plot', ['outputdim_' mode '_m' num2str(m) '_rho_' num2str(rho_noise) '_' tstamp]);
...
saveas(gcf, fullfile(plot_root, ['SM_outputdim_' mode '_m' num2str(m) '_rho_' num2str(rho_noise) '.png']))